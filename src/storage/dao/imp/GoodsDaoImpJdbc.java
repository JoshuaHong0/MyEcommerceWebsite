...
public class GoodsDaoImpJdbc implements GoodsDao {
    ...
    private Goods populate(ResultSet rs) throws SQLException {
    ...
    public void modify(Goods goods) {
        ...
        String sql = "update Goods set name=?,price=?,description=?,brand=?,cpu_brand=?,cpu_type=?,memory_capacity=?,hd_capacity=?,card_model=?,displaysize=?, image=? " +
                "where id = ?";
